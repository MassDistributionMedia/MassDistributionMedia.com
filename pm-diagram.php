	   ...
	   public function howTour()
		...
		public function openHelp(){
				Animate::Size($this->howPanel, 555, 303, 777, 15, 55);
					...
					Animate::Opacity($this->closeZoomHow, 100, 1333);
		...
		public function resetArrow(){
				...
				$this->howResetPanel->Controls->Add($this->zeroKey = new Image("http://png.161.be/zero_key.png", 393, 111, null, 80));
